...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay2 = new Payment(null, Instant.parse("2023-08-23T19:00:00Z"), o2);
		Payment pay3 = new Payment(null, Instant.parse("2023-08-23T19:00:00Z"), o3);
		...
		Category c2 = new Category(null, "healthcare");
